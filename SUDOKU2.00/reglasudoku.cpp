...
ReglasSudoku::ReglasSudoku(const ReglasSudoku& otro) {
	...
	// Copiar la lista de posiciones bloqueadas
...
int ReglasSudoku::dame_contador() const {
	return this->cont;
}
...
tCelda ReglasSudoku::dame_celda_bloqueada(int p, int& f, int& c) const {
...
bool ReglasSudoku::es_valor_posible(int f, int c, int v) const {
